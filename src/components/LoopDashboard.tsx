...
export default function LoopDashboard({ isOpen, onClose }: LoopDashboardProps) {
 ...
 className="relative bg-[#0a0a0a] border border-brand-accent/20 rounded-[28px] shadow-none max-w-6xl w-full h-[88vh] flex flex-col overflow-hidden"
 >
 {/* Header */}
 ...
 className="h-full bg-gradient-to-l from-brand-accent to-brand-deep rounded-full shadow-none"
 />
 </div>
 </div>
