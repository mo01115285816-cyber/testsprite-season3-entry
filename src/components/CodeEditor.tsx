...
<body>
 ...
 <div className="relative flex items-center bg-brand-bg border border-brand-accent/20 rounded-xl px-3 py-1.5 focus-within:border-brand-accent/50 focus-within:shadow-none transition-all w-full sm:w-80">
 <button
