...
const AppleMarkdownRenderer = ({ content, onCopy, copiedId }: { content: string, onCopy: (text: string, id: string) => void, copiedId: string | null }) => {
 ...
 <div key={`code-block-${idx}`} className="my-6 border border-brand-accent/20 rounded-2xl overflow-hidden bg-brand-bg shadow-none" dir="ltr">
...
export default function ChatAgent({
 ...
 <header className="relative rounded-[26px] bg-brand-card/90 backdrop-blur-2xl border border-brand-accent/25 shadow-none p-1.5 pr-5 pl-1.5 flex items-center justify-between transition-all duration-500 h-[50px]">
 ...
 width={24}
 height={24}
 className="w-6 h-6 object-contain drop-shadow-none"
 />
 </div>
 ...
 : 'border-brand-accent/20 shadow-none'
