...
export default function LivePreview({
 ...
 previewSize === 'desktop' ? 'bg-brand-accent/10 text-brand-accent border border-brand-accent/30 shadow-none' : 'text-zinc-400 hover:text-brand-accent hover:bg-[#141414]'
 }`}
 ...
 className={`p-1.5 rounded-lg transition-all cursor-pointer ${
 previewSize === 'tablet' ? 'bg-brand-accent/10 text-brand-accent border border-brand-accent/30 shadow-none' : 'text-zinc-400 hover:text-brand-accent hover:bg-[#141414]'
 }`}
 ...
 className={`p-1.5 rounded-lg transition-all cursor-pointer ${
 previewSize === 'mobile' ? 'bg-brand-accent/10 text-brand-accent border border-brand-accent/30 shadow-none' : 'text-zinc-400 hover:text-brand-accent hover:bg-[#141414]'
 }`}
 ...
 inspectModeActive 
 ? 'bg-gradient-to-r from-brand-accent via-brand-deep to-brand-accent text-brand-bg border-brand-accent shadow-none' 
 ...
 {previewSize === 'desktop' && (
 <div className="w-full h-full max-w-7xl mx-auto bg-white rounded-2xl shadow-none overflow-hidden border border-brand-accent/20 flex flex-col">
 ...
 <span className="w-3 h-3 rounded-full bg-brand-accent/80 shadow-none"></span>
 </div>
